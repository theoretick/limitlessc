...
<p><a href="https://play.google.com/store/apps/details?id=phuc.entertainment.dualnback" target="_blank"><img style="width: 150px;" src="/storage/nback-images/Nguyen.png" alt="Nguyen's Brain N-Back" /></a></p>
...
<div></div>
<p><a href="https://play.google.com/store/apps/details?id=com.Projet4A.DualNBack" target="_blank"><img style="width: 150px;" src="/storage/nback-images/polytechmarseille.png" alt="Polytech's DualNBack" /></a></p>
<p> + Clean Interface</p>
<p> + Easy N- adjustment (cool little side buttons)</p>
<p> - Virtually no adjustment otherwise (stimulus, sessions, orientation, etc.)</p>
<p> - No statistics</p>
<p class="ratings"> Rating: 3 / 10</p>
<br />
...
<div></div>
<p><strong><a href="https://play.google.com/store/apps/details?id=cz.wie.p.nback" target="_blank"><img style="width: 150px;" src="/storage/nback-images/Piotr.png" alt="Piotr's NBack" /></a></strong></p>
...
<p><a href="https://play.google.com/store/apps/details?id=org.urbian.android.games.nback" target="_blank"><img style="width:150px;" src="/storage/nback-images/nbackmaestro.png" alt="N-Back Maestro" /></a></p>
...
<p><a href="https://play.google.com/store/apps/details?id=waterdev.NBack" target="_blank"><img style="width: 150px;" src="/storage/nback-images/Waterdev.png" alt="Waterdev's N-Back" /></a></p>
...
<p><a href="https://play.google.com/store/apps/details?id=com.ankerl.singlenback" target="_blank"><img style="width:150px;" src="/storage/nback-images/singlenback.png" alt="Single N-Back" /></a></p>
<p> + Simplicity</p>
...
<p><a href="https://play.google.com/store/apps/details?id=appinventor.ai_viana_octavio.IQ_Boost" target="_blank"><img style="width: 150px;" src="/storage/nback-images/IQBoost.png" alt="IQ Boost" /></a></p>
...
<h3>The Winner:</h3>
<p>Piotr's NBack clearly has the best feature set and options that I really want in an app, yet an awkward layout (at least for my 4.3" screen) and while it has most of what I'm looking for, one other seems to bring it all together in the most well-packaged and balanced way, so without further ado:</p>

<p class="ratings">Nguyen's N-Back</p>

<p>While there are a couple features still lacking, Nguyen's still had the greatest set of features with the right amount of interface polish. It still is missing some features but Nguyen appears to be a pretty great dev who responds to all requests, so I'll be submitting my desired ones and we shall see if we can't make the best one so far a bit better. Meanwhile, if you feel like supporting him, there's a <a class="offsite-link-inline" href="https://market.android.com/details?id=phuc.entertainment.dualnbackpremium&amp;feature=search_result" target="_blank">"premium" ad-free version on the market</a>.</p>
...
<li><strong>Session limits for the day</strong>, i.e. stopping at 20 rather than infini-loop</li>
</ul>
<br />
-----
COMMENTS:
